...
if (isset($_POST["btnLogin"])) {
    $postArray = array("txtUsername", "txtPassword");
    $isEmpty = false;
    ...
    if ($isEmpty) {
        ...
        if (!$FC->login($_POST["txtUsername"], $_POST["txtPassword"])) {
            echo "<script>alert('Onjuiste inloggegevens!')</script>";
        }
    }
}
?>
    ...
    <header id="logobg">
        <div class="container">
            <div class="col-md-12 filminfobackground" id="login" style="height: 100vh; z-index: 50;">
                ...
                <a href="register.php" style="color: #343a40">Nog geen account?</a>
            </div>
        </div>
    </header>
    <!-- Optional JavaScript -->
